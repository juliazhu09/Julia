...
\begin{figure}[h!]
	...
	\quad
	\subfloat[25\% Right Censored]{\label{fig:base25}\includegraphics[width=3in]{base25.png}}
	\quad
	\subfloat[50\% Right Censored ]{\label{fig:base50}\includegraphics[width=3in]{base50.png}}
	\quad
	\subfloat[75\% Right Censored]{\label{fig:base75}\includegraphics[width=3in]{base75.png}}
...
\begin{figure}[h!]
	\centering
	\subfloat[No Right Censor ]{\label{fig:diffno}\includegraphics[width=3in]{diff0.png}}
	\quad
	\subfloat[25\% Right Censored]{\label{fig:diff25}\includegraphics[width=3in]{diff25.png}}
	\quad
	\subfloat[50\% Right Censored ]{\label{fig:diff50}\includegraphics[width=3in]{diff50.png}}
	\quad
	\subfloat[75\% Right Censored]{\label{fig:diff75}\includegraphics[width=3in]{diff75.png}}
...
\begin{table}[htbp]
	...
	\begin{tabular}{L{3.5cm}lllllrrrr}
		...
		%9 models by COCS & N/A   & N/A   & N/A   & N/A   & N/A   &    24.62 & 3.40  & 117.9 & 0.26 \\
...
%			A65*P85 & 1     & -1.610(0.206)*** & .     & -0.662(0.177)*** & . \\
%			ERIP*P85 & 1     & 0.469(0.179)** & .     & 0.600(0.130)*** & . \\
               division & dir2  & -0.965 (0.179)*** & 0.381 & -0.969 (0.177)*** & 0.38 \\
               division & dir3  & -0.241 (0.112)* & 0.786 & -0.242 (0.111)* & 0.785 \\
               division & dir4  & 0.078 (0.195) & 1.081 & 0.013 (0.195) & 1.013 \\
               division & dir5  & -0.131 (0.19) & 0.877 & -0.216 (0.19) & 0.806 \\
               division & dir6  & 2.136 (0.095)*** & 8.463 & 2.261 (0.093)*** & 9.594 \\
               division & dir7  & 2.435 (0.129)*** & 11.418 & 2.515 (0.128) & 12.363 \\
               division & dir8  & 0.864 (0.106)*** & 2.373 & 0.855 (0.106)*** & 2.352 \\
               division & dir9  & -3.023 (0.581)*** & 0.049 & -2.731 (0.504)*** & 0.065 \\
               division & dir10 & 0.793 (0.093)*** & 2.211 & 0.726 (0.093)*** & 2.068 \\
...
\begin{table}[h!]
	...
	\scriptsize
	\smallskip
	\caption{Predictions by Occupational Code (COCS)}
	\begin{threeparttable}
...
\subsection{Models for Retirement with External Economic Variables}
   ...
   \begin{table}[h!]
   		...
   		\scriptsize
   		\smallskip
   		\caption{Retirement with Real Earnings Predictions by Occupational Code (COCS)}
   		\begin{threeparttable}
   			\begin{tabular}{cL{1.2cm}L{1.2cm}L{1.2cm}L{1.2cm}L{1.2cm}L{1.2cm}L{1.2cm}L{1.2cm}L{1.2cm}l}
   				\toprule
   				Year  &  Crafts & Engineers& General Admin. & Laborers& Managers& Prof. Admin.& Operators& Scientists& Technicians& Total \\
...
\begin{table}[htbp]
	...
	\begin{threeparttable}
		\begin{tabular}{llL{2.5cm}L{1.5cm}L{2.5cm}L{1.5cm}}
			...
			Parameter &   Label & Parameter (Standard Error) & Hazard Ratio & Parameter (Standard Error) & Hazard Ratio \\
			\midrule
			division & dir1  & -3.066 (0.263)*** & 0.047 & -3.305 (0.269)*** & 0.037 \\
			division & dir2  & -2.652 (0.198)*** & 0.071 & -2.875 (0.204)*** & 0.056 \\
			division & dir3  & -3.015 (0.253)*** & 0.049 & -3.258 (0.258)*** & 0.038 \\
			division & dir4  & -2.533 (0.288)*** & 0.079 & -2.769 (0.292)*** & 0.063 \\
			division & dir5  & -2.739 (0.314)*** & 0.065 & -2.934 (0.317)*** & 0.053 \\
			division & dir7  & 0.028 (0.145) & 1.029 & 0.101 (0.146) & 1.107 \\
			division & dir8  & -0.806 (0.157)*** & 0.447 & -0.968 (0.163)*** & 0.38 \\
			division & dir9  & -3.985 (0.586)*** & 0.019 & -4.207 (0.588)*** & 0.015 \\
			division & dir10 & -1.325 (0.136)*** & 0.266 & -1.5 (0.142)*** & 0.223 \\
			...
			Age at Credited &       & -0.025 (0.005)*** & 0.975 & -0.026 (0.005)*** & 0.974 \\
...
\begin{table}[h!]
	...
	\scriptsize
	\smallskip
	\caption{Voluntary Quitting Model with External Variables Predictions by Occupational Code (COCS)}
	\begin{threeparttable}
		\begin{tabular}{cL{1.2cm}L{1.2cm}L{1.2cm}L{1.2cm}L{1.2cm}L{1.2cm}L{1.2cm}L{1.2cm}L{1.2cm}l}
			\toprule
			Year  &  Crafts & Engineers& General Admin. & Laborers& Managers& Prof. Admin.& Operators& Scientists& Technicians& Total \\
