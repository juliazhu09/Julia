...
\author[1]{Bruce Holt}%\footnote{Former Student}
...
\begin{figure}[h!]
	\centering
	\subfloat[Survival Function]{\label{fig:Surv}\includegraphics[height=0.3\textwidth,width=0.5\textwidth]{Surv.png}}
	\subfloat[Cumulative Hazard]{\label{fig:Cumh}\includegraphics[height=0.3\textwidth,width=0.5\textwidth]{logcum.png}}
	%\subfloat[Hazard function]{\label{fig:Hazard}\includegraphics[width=0.35\textwidth]{loghazard.png}}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\textwidth]{retire2.png}
...
Predictive results for voluntary quitting without external variables appear in Table \ref{tab:cocscode} columns 5 and 6. The quitting volumes are much lower than retirements in general but average predictions are highly accurate for both training and holdout with the most sizeable deviation occurring for general administration under-predicting by 2.6 units on average.
...
5) Factors that did not seem to significantly impact retirement decisions included gender, payroll classification, job classification code, and a large number of additional financial indexes.
